export class Cookie {
      ...
      // เป็น function ที่จะ get value ของ cookie ที่เราต้งการ
      static getCookie(name) {
        ...
        // ใช้ method split เเยก cookie เเต่ละอันออกมาใส่ไว้ใน cookieArr (เก็บเป็น array) โดยจะเเยก cookie เเต่ละอันด้วย '; ' 
        ...
        // เป็นการเช็นว่า cookie เป็น udefind รึป่าว (ถ้สเป็น undefind เเสดงว่าไม่มี cookie ชื่อนี้อยู่ใน cookie session)
        if(cookie == undefined) {
          ...
          // จะใชช้ split ในการเเยก ซึ่งจะเเยกที่เครื่องหมาย '=' เเละเอาเเค่ index ที่ 1 ซึ่งก็คือ value 
    ...
    // fumction ที่จะลบ cookie ตามชื่อที่ใส่มาออก โดยไปกำหนดให้มันหมดอายุ
    static unset1(name) {
